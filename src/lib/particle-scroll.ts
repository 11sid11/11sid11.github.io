/**
 * Particle Scroll engine copied from Canvas UI.
 * Copyright (c) 2026 David Haz.
 * Licensed under the MIT License with Commons Clause; see THIRD_PARTY_NOTICES.md.
 * Source: https://canvasui.dev/docs/components/particle-scroll
 */
